...
- **Frontend Actions:**
  ...
  - `send_chat { message }`
- **WS Server Events:** Listen for `{ type: "chat_message", sender_id, content, timestamp }`. _Players are automatically subscribed to their syndicate chat room upon WS Auth._
